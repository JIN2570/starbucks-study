...
// api를 사용하려면 다양한 명령으로 동영상 제어 가능

// (참고) <iframe> 태그: HTML 문서 내에 다른 문서를 삽입하는데 사용(웹 페이지 내에 웹페이지를 표시)
...
let player;
function onYouTubeIframeAPIReady() { //라이브러리가 이 함수의 이름을 찾ㅇ 실행하기에 임의로 바꾸면 안됨
